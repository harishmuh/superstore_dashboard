...
CURR_YEAR = max(df['order_date'].dt.year) # current year
PREV_YEAR = CURR_YEAR - 1 # Previous year

st.title("Superstore Dashboard")

# st.write(CURR_YEAR)

# Menampilkan dataframe di dashboard
...
with mx_customer:
    ...
    st.metric("customer", value=curr_customer, delta=f'{sales_diff_pct:.2f}%')
...
# Membuat grafik korelasi dengan scatter plot
